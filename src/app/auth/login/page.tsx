    ...
    return(
        <div className="wrapper space-y-10">
            ...
            <div className="form flex flex-col gap-10 items-center">
                <h2 className="text-[var(--charcoal-black)] text-lg font-bold">Sign in to your account</h2>
                <form className="flex flex-col items-center space-y-10" onSubmit={handleSubmit}>
                    <InputField width="w-[462px]" helperText="input already existing email address" label="Email Address" placeholder="email address" name="email" value={formData.email} onChange={handleChange} required fullWidth/>
